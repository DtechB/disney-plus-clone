...
function Home() {
  return (
    <main className="Home">
      ...
      <Movie title="Recommended for you" data={recommendedMovieData} />
      <Movie title="New to Disney+" data={newMovieData} />
      <Movie title="Orginals" data={originalsMovieData} />
      <Movie title="Trending" data={trendingMovieData} />
    </main>
  );
}
